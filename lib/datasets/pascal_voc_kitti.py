...
#        self.num_classes = len(self._classes)
    ...
    def _do_python_eval(self, output_dir='output', difficult=1):
        ...
        for i, cls in enumerate(self._classes):
            if cls == 'bg' or cls == '__background__' or cls == 'misc' or cls == 'dontcare' or cls == 'van' or cls == 'truck' or cls == 'tram' or cls == 'person_sitting':
                continue
            filename = self._get_voc_results_file_template().format(cls)
            if cls == 'car':
                thresh = 0.7
            ...
            rec, prec, ap = voc_eval(
                ...
                use_07_metric=use_07_metric, difficult=difficult)
            aps += [ap]
    ...
    def evaluate_detections(self, all_boxes, output_dir, difficult=1):
        self._write_voc_results_file(all_boxes)
        self._do_python_eval(output_dir, difficult)
